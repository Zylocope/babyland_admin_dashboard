      ...
      <div className="surface-card p-6">
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button type="submit" disabled={saving} className="inline-flex items-center gap-2 px-4 py-2 text-sm bg-brand text-white rounded-lg hover:bg-brand-hover font-medium disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer">
